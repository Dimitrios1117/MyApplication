package com.example.dimitrios.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    GsonBuilder gsonb;
    private Gson mGson;
    //Map<String, String> tempftw = new HashMap<String, String>();
    SparseArray<ArrayList<NoteCard>> tempftw = new SparseArray<>();
    //NoteCard asd = new NoteCard("asd","asd");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //cardPosition = 0;
        mSettings = getSharedPreferences("my_cards", Context.MODE_PRIVATE);
        mEditor = mSettings.edit();
        //mEditor.apply();
        gsonb = new GsonBuilder();
        mGson = gsonb.create();
        tempftw.put(1,noteCards);
